...
def _draw_icon(screen: Screen, index: int, symbol: str = "") -> int:
    ...
    screen.cursor.fg = as_rgb(color_as_int(Color(230, 225, 207)))
    screen.cursor.bg = as_rgb(color_as_int(Color(92, 103, 115)))
    screen.draw(symbol)
